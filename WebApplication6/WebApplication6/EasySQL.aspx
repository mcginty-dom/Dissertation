<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EasySQL.aspx.cs" Inherits="WebApplication6.EasySQL" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Easy SQL Injection</title>
...
<body class="vulnbg">
    <form id="form1" runat="server">
            ...
            <div>
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="#"><u>Easy SQL</u></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="jumbotron bg-dark text-light">
            <div class="container">
                <h1 class="display-4">Easy SQL Injection</h1>
        ...
        <div class="container border border-dark rounded">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:GridView ID="GridView1" runat="server" CellPadding="5" CellSpacing="5" Font-Size="X-Large">
                        </asp:GridView>
                    </div>
                </div>
            </div>
